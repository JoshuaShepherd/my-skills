...
2. Read `{{STYLES_PATH}}` for existing animation tokens
...
**Layer separation**: Use Gemini to generate depth-separated layers from a single image:
```
...
**Use Gemini + Video Model approach:**
...
### Source: {{OUTPUT_DIR}}/hero/{{course-slug}}.png
### Animation: Ken Burns (slow pan & zoom)
### Output Format: GSAP + React Component

### Implementation
- Component: {{COMPONENTS_DIR}}/content/AnimatedHero.tsx
