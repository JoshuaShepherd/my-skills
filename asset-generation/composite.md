...
3. Read `{{CONFIG_PATH}}` for brand context (labels, colors)
...
### Method A — Gemini Compositing (AI-Assembled)
Use Gemini Image Generation to compose images together with AI understanding of layout and aesthetics.
...
### Layout: Grid (4×2)
### Source Images: 8 files from {{OUTPUT_DIR}}/series/{{course-slug}}/
### Output: {{OUTPUT_DIR}}/composite/{{course-slug}}-overview.png
