...
Edit an image asset using Gemini Image Generation: $ARGUMENTS

$ARGUMENTS should include:
- Path to the source image (in `{{IMAGES_DIR}}/` or elsewhere)
...
### Source
- File: {{OUTPUT_DIR}}/hero/{{course-slug}}-1.png

### Edit Applied
> "Make the lighting warmer with golden-hour tones, add subtle bokeh to the background"

### Result
- File: {{OUTPUT_DIR}}/hero/{{course-slug}}-1-edited.png
