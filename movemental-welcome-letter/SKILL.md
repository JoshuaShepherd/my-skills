...
2. `content-analysis.md` — asset titles, retail platforms, podcast appearances.
3. `digital-presence-discovery.md` — verified URLs, social handles, partner publications.
4. `summary.md` — short biographical synthesis, current role.
5. `biography.md` (if present).
6. `<SLUG_UPPER>_AUTHOR_PROFILE.md`, `<SLUG_UPPER>_CONTENT_AUDIT.md`, `<SLUG_UPPER>_COMPLETE_PROFILE.md`, `<SLUG_UPPER>_AUDIENCE_PROFILE.md`, `<SLUG_UPPER>_CALLING_PROFILE.md`, `<SLUG_UPPER>_ORGS.md`, `<SLUG_UPPER>_TIMELINE.md` — leader-specific structured profiles.
7. `gap-analysis.md`, `movemental-analysis.md` — useful for the embodied-layer paragraph and the four-moves paragraph.
8. `identity-verification.md` — confirm display name spelling.
