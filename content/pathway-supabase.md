...
Write results to `~/Desktop/Dev/repos/docs/content-research/supabase-export/`:
...
Write discrepancies to `~/Desktop/Dev/repos/docs/content-research/supabase-export/DISCREPANCIES.md`.
