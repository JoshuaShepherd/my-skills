---
name: app-architect
description: Generate a full architectural documentation package for any app, project, or feature — a _PURPOSE.md narrative plus individual page-level specs, navigation, and cross-cutting concerns. Outputs to a configurable docs directory for use in AI Studio or any prototyping tool.
user-invocable: true
...
- Optionally: a custom output directory (default: `{{APP_ROOT}}/_docs/architecture/`)
...
**What it produces:**
- A project directory under `{{APP_ROOT}}/_docs/architecture/[project-slug]/`
...
Create `{{APP_ROOT}}/_docs/architecture/[project-slug]/` if it doesn't exist. If the user specifies a custom output directory, use that instead.
...
### Files Created
- `[output-dir]/[slug]/_PURPOSE.md` — Overall project narrative
- `[output-dir]/[slug]/[page-1].md` — [One-line purpose]
- `[output-dir]/[slug]/[page-2].md` — [One-line purpose]
- ...
- `[output-dir]/[slug]/_NAVIGATION.md` — Navigation and routing
- `[output-dir]/[slug]/_CROSS_CUTTING.md` — Shared concerns
