...
5. Read `_docs/PORTAL_MAP_AND_CHRISTOCENTRIC_SPINE.md` — theological spine
6. Read `_docs/COURSE_STRATEGY.md` — formation philosophy (voice markers, transformation loop)
7. Read `_docs/business/` — business model context (pricing, audiences, positioning)
...
| # | Section | Purpose | Mandatory? | Spec |
|---|---------|---------|------------|------|
| 4 | **Pathways / Themes** | Framework entry points | YES (if pathways exist) | 3–6 cards linking to thematic portals. Each card: icon/image, title, 1-line description. This is the "table of contents" for the leader's body of work. |
