---
name: youtube-scrape
description: Scrape YouTube channel videos — fetches metadata, downloads transcripts via yt-dlp, chunks for search, and pulls comments. Upserts into the videos table.
user-invocable: true
