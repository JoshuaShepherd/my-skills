...
Examples:
- `books the-forgotten-ways` — write all missing paratext for one book
- `books all` — write missing paratext for every book
- `courses forgotten-ways` — write missing paratext for one course
- `courses all` — write missing paratext for every course
- `chapters the-forgotten-ways` — write chapter excerpts for one book
