...
description: "Comprehensive PostgreSQL reference covering performance optimization, schema design, indexing, query patterns, connection management, security, and advanced features. Use this skill when writing, reviewing, or optimizing Postgres queries, schema designs, migrations, or database configurations."
risk: unknown
source: community
...
- [dhamaniasad/awesome-postgres](https://github.com/dhamaniasad/awesome-postgres) — Curated list of PostgreSQL software, libraries, tools, and resources (11,759+ GitHub stars, CC0-1.0)
