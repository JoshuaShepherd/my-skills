---
name: course-author
description: Generate course content for a specific section of the transformation loop, following the actual mDNA course structure, Charter requirements, and Alan Hirsch's voice. Use when writing individual course sections.
user-invocable: true
...
$ARGUMENTS should include: course slug, week number, and section type (e.g., `mdna 3 dissonance` or `mdna 4 teaching`). If incomplete, ask the user.
...
3. Check the course's existing content for context:
   ...
   - mDNA course.json at `/Users/joshuashepherd/Desktop/Dev/repos/mdna-course/editor/data/course.json` — use this as the canonical reference for tone, depth, and structure
4. If corpus material exists, read relevant source chapters:
   - Check `/Users/joshuashepherd/Desktop/Dev/repos/mdna-course/_docs/corpus/` or equivalent for book chapters
