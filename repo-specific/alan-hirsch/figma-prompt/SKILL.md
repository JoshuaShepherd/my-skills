...
**Feature-specific templates** — generate 2–3 more based on the specific feature (e.g., for a long-form content page: sticky sidebar active state, accordion open-state animation, related pathway card hover treatment).
