...
- Optionally: a scope to audit (`all`, `heroes`, `courses`, `books`, `pathways`, `pathways`, `pages`, `og`, `cards`)
...
| `public/images/art/pathways/` | Pathway/theme imagery & icons | `art-pathway-{slug}.webp`, `pathway-{slug}-icon-2x.webp` |
...
| `themes[].coverImage` | Cover | Theme/pathway pathway art |
...
| `PathwayCard` | `imageUrl` (optional) | None shown |
...
|------|------|-----------|-------|
| src/app/(public)/page.tsx | 76 | /images/art/courses/course-mdna-cover-desktop.webp | OK |
| ... | ... | ... | ... |
...
- **`pathways`** — Pathway cover images, hero images, pathway cards
- **`pathways`** — Theme/pathway card images in tenant config
