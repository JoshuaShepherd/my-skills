...
/asset-prompt-library use hero-course --var title="The mDNA" --var subject="an open compass on a hand-drawn map with a seedling growing beside it"
```
...
>
> The image should include "The mDNA" in bold serif text,
