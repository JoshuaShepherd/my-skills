...
type RetrievalIntent =
  ...
  | 'CROSS_BOOK_COMPARISON'   // "Compare mDNA with Reframation on..."
...
```typescript
// Input: "books/mdna/ch03-apostolic-environment.md"
// Output: { bookSlug: "mdna", chapter: 3, section: "apostolic-environment" }
