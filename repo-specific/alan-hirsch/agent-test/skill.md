...
describe('routeRetrieval', () => {
  ...
  it('classifies book-specific queries', () => {
    const result = routeRetrieval('Summarize chapter 3 of mDNA', { booksFocus: ['mdna'] });
...
describe('parseSource', () => {
  it('extracts book slug and chapter from file path', () => {
    const source = parseSource('books/mdna/ch03-apostolic-environment.md');
    expect(source.bookSlug).toBe('mdna');
