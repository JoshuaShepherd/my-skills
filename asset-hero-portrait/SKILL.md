---
name: asset-hero-portrait
description: Create wide-format hero images featuring an author/thought leader from existing photos using Nano Banana 2. Handles background extension, atmospheric contexts, split compositions, and cinematic treatments for page heroes, landing pages, and featured sections.
user-invocable: true
...
2. Read `src/lib/config/tenant.config.ts` — check current `hero.imageUrl` and `hero.backgroundImageUrl`
3. Read the source image to understand current crop, quality, and expression
4. Check for author style guide at `_docs/asset-prompts/author-style-guide.md`
...
Background: [clean studio gradient — warm cream (#FAF5E4) to warm grey (#8B8680) /
...
colors transitioning to rich warm charcoal (#2C2220) / light gradient — from the
subject's environment colors transitioning to warm cream (#FAF5E4)].
...
for (const part of response.candidates[0].content.parts) {
  if (part.inlineData) {
    ...
    const outDir = "public/images/generated/hero-portrait";
...
warm charcoal (#2C2220), deep amber shadows, warm black. Designed for
...
cream (#FAF5E4), soft warm grey, warm white. Designed for light mode
...
|---------|------|-----------|------|
| Primary | public/images/generated/hero-portrait/alan-home-hero.png | 1920×1080 | Universal |
| Dark mode | public/images/generated/hero-portrait/alan-home-hero-dark.png | 1920×1080 | Dark |
| Light mode | public/images/generated/hero-portrait/alan-home-hero-light.png | 1920×1080 | Light |
