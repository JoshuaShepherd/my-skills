...
- Course slug or name (e.g., `forgotten-ways`, `reframation`, `mdna`)
...
2. If this is the Forgotten Ways course, read `/Users/joshuashepherd/Desktop/Dev/repos/forgotten-ways-course/editor/data/course.json` for canonical content
...
**Naming convention**: `[video-id]` = `[course]-w[NN]-[type]` (e.g., `forgotten-ways-w03-opening`, `mdna-explainer`, `reframation-w05-social-30s`)
