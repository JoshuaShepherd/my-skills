...
- **Mention all states** — Tell Stitch about empty, loading, error, and success states
...
### DON'T:
- **Don't prescribe design** — No colors, fonts, layouts, components, spacing, CSS, Tailwind, or visual style
