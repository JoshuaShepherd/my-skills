...
2. Read the global CSS for chat-specific styles (search for chat-related class names)
3. Read any configuration file for chat settings (placeholder text, labels, feature flags)
4. If auditing layout/frame, also read the parent layout components
...
- [ ] **Viewport offset alignment**: Container correctly accounts for any persistent nav bars via CSS custom properties or calc()
...
- [ ] **Placeholder text**: Contextual placeholder that disappears on focus
...
- [ ] **Consistent iconography**: Single icon library; 16-20px in messages, 20-24px for buttons
...
3. Use the project's component library where applicable
4. Respect the project's CSS custom property system
