...
**Corpus seed root:** `data/corpus/alan-hirsch/`  
**Formatting exemplar:** `C:\Users\Josh\Desktop\movemental-docs\docs\library\corpus\alan-hirsch\the-church-as-movement\`  
**Started:** YYYY-MM-DD  
...
**Remediation pass:** no / yes ([`REMEDIATION.md`](REMEDIATION.md))  
**Current phase:** 0
...
|-------|-------|
| book_slug | |
| corpus_seed_path | `data/corpus/alan-hirsch/{book_slug}/` or none |
